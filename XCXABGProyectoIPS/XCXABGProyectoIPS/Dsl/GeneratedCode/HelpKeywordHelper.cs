...
namespace IPS_GT16.XCXABGProyectoIPS
{
	...
	/// </remarks>
	public partial class XCXABGProyectoIPSHelpKeywordHelper : XCXABGProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected XCXABGProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the XCXABGProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static XCXABGProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class XCXABGProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected XCXABGProyectoIPSHelpKeywordHelperBase()
			: base() { }
