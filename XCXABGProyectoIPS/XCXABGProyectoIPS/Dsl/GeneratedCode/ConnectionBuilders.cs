...
namespace IPS_GT16.XCXABGProyectoIPS
{
	...
	/// </summary>
	public static partial class EntidadReferencesRelacionedBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::IPS_GT16.XCXABGProyectoIPS.Entidad)
			{ 
				return true;
			}
			else
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::IPS_GT16.XCXABGProyectoIPS.Relacion)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::IPS_GT16.XCXABGProyectoIPS.Entidad)
				{
					if (candidateTarget is global::IPS_GT16.XCXABGProyectoIPS.Relacion)
					{
						global::IPS_GT16.XCXABGProyectoIPS.Entidad sourceEntidad = (global::IPS_GT16.XCXABGProyectoIPS.Entidad)candidateSource;
						global::IPS_GT16.XCXABGProyectoIPS.Relacion targetRelacion = (global::IPS_GT16.XCXABGProyectoIPS.Relacion)candidateTarget;
						if(targetRelacion == null || sourceEntidad == null || global::IPS_GT16.XCXABGProyectoIPS.EntidadReferencesRelacioned.GetLinks(sourceEntidad, targetRelacion).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::IPS_GT16.XCXABGProyectoIPS.Entidad)
				{
					if (target is global::IPS_GT16.XCXABGProyectoIPS.Relacion)
					{
						global::IPS_GT16.XCXABGProyectoIPS.Entidad sourceAccepted = (global::IPS_GT16.XCXABGProyectoIPS.Entidad)source;
						global::IPS_GT16.XCXABGProyectoIPS.Relacion targetAccepted = (global::IPS_GT16.XCXABGProyectoIPS.Relacion)target;
						DslModeling::ElementLink result = new global::IPS_GT16.XCXABGProyectoIPS.EntidadReferencesRelacioned(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class EntidadRelacionConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new EntidadRelacionConnectAction for the given Diagram.
		/// </summary>
		public EntidadRelacionConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		private partial class EntidadRelacionConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the EntidadRelacionConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected EntidadRelacionConnectionTypeBase() : base() {}
		...
		private partial class EntidadRelacionConnectionType : EntidadRelacionConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the EntidadRelacionConnectionType with the given ConnectionBuilder.
			/// </summary>
			public EntidadRelacionConnectionType() : base() {}
		}
	}
}
