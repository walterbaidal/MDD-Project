...
namespace IPS_GT16.XCXABGProyectoIPS
{
	...
	/// </remarks>
	public partial class XCXABGProyectoIPSToolboxHelper : XCXABGProyectoIPSToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSToolboxHelper.
		/// </summary>
		public XCXABGProyectoIPSToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class XCXABGProyectoIPSToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify XCXABGProyectoIPS toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "XCXABGProyectoIPS.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify EntidadRelacion connector tool.
		/// </summary>
		public const string EntidadRelacionFilterString = "EntidadRelacion.1.0";
		...
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSToolboxHelperBase.
		/// </summary>
		protected XCXABGProyectoIPSToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSDomainModel.SingletonResourceManager.GetString("XCXABGProyectoIPSToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "IPS_GT16.XCXABGProyectoIPS.EntidadToolboxItem":
					// Add Entidad shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"IPS_GT16.XCXABGProyectoIPS.EntidadToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("XCXABGProyectoIPSToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::IPS_GT16.XCXABGProyectoIPS.Entidad.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "IPS_GT16.XCXABGProyectoIPS.RelacionToolboxItem":
					// Add Relacion shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"IPS_GT16.XCXABGProyectoIPS.RelacionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::IPS_GT16.XCXABGProyectoIPS.Relacion.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "IPS_GT16.XCXABGProyectoIPS.EntidadRelacionToolboxItem":

					// Add EntidadRelacion connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"IPS_GT16.XCXABGProyectoIPS.EntidadRelacionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						3, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("EntidadRelacionToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("EntidadRelacionToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("XCXABGProyectoIPSToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"EntidadRelacion", // F1 help keyword for the toolbox item.
						resourceManager.GetString("EntidadRelacionToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(EntidadRelacionFilterString)
						});
					break;
				case "IPS_GT16.XCXABGProyectoIPS.AtributoRelacionToolboxItem":
					// Add AtributoRelacion shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"IPS_GT16.XCXABGProyectoIPS.AtributoRelacionToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::IPS_GT16.XCXABGProyectoIPS.AtributoRelacion.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "IPS_GT16.XCXABGProyectoIPS.AtributoEntidadToolboxItem":
					// Add AtributoEntidad shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"IPS_GT16.XCXABGProyectoIPS.AtributoEntidadToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::IPS_GT16.XCXABGProyectoIPS.AtributoEntidad.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "IPS_GT16.XCXABGProyectoIPS.ClavePrimariaToolboxItem":
					// Add ClavePrimaria shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"IPS_GT16.XCXABGProyectoIPS.ClavePrimariaToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						CreateElementToolPrototype(store, global::IPS_GT16.XCXABGProyectoIPS.ClavePrimaria.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSDomainModel));
