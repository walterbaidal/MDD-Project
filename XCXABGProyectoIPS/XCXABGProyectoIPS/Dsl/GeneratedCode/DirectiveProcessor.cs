...
namespace IPS_GT16.XCXABGProyectoIPS
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides XCXABGProyectoIPS files
	/// The implementation is done in XCXABGProyectoIPSDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class XCXABGProyectoIPSDirectiveProcessor : XCXABGProyectoIPSDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public XCXABGProyectoIPSDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides XCXABGProyectoIPS files
	/// </summary>
	public class XCXABGProyectoIPSDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string XCXABGProyectoIPSDirectiveProcessorName = "XCXABGProyectoIPSDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "Tapiz";
		...
		/// </summary>
		private const string supportedDirectiveName = "XCXABGProyectoIPS";
		...
		/// Constructor
		/// </summary>
		public XCXABGProyectoIPSDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return XCXABGProyectoIPSDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::IPS_GT16.XCXABGProyectoIPS.Tapiz));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::IPS_GT16.XCXABGProyectoIPS.Tapiz));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "Tapiz" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("XCXABGProyectoIPSDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("IPS_GT16.XCXABGProyectoIPS");
