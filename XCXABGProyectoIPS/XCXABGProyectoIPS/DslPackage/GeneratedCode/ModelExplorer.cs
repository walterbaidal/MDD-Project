...
namespace IPS_GT16.XCXABGProyectoIPS
{
	...
	/// </summary>
	internal partial class XCXABGProyectoIPSExplorer : XCXABGProyectoIPSExplorerBase
	{
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSExplorer.
		/// </summary>
		public XCXABGProyectoIPSExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the XCXABGProyectoIPSExplorerToolWindow.
	/// </summary>
	internal abstract class XCXABGProyectoIPSExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSExplorerBase.
		/// </summary>
		protected XCXABGProyectoIPSExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.XCXABGProyectoIPSExplorerMenu;
			}
		}
		...
		{
			get { return global::IPS_GT16.XCXABGProyectoIPS.Tapiz.DomainClassId; }
		}
