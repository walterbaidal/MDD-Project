...
namespace IPS_GT16.XCXABGProyectoIPS
{
	...
	/// </summary>
	internal partial class XCXABGProyectoIPSDocView : XCXABGProyectoIPSDocViewBase
	{
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSDocView.
		/// </summary>
		public XCXABGProyectoIPSDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class XCXABGProyectoIPSDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSDocView.
		/// </summary>
		protected XCXABGProyectoIPSDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			XCXABGProyectoIPSDocDataBase docData = this.DocData as XCXABGProyectoIPSDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for XCXABGProyectoIPSDocViewBase should be an XCXABGProyectoIPSDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.XCXABGProyectoIPSDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::IPS_GT16.XCXABGProyectoIPS.XCXABGProyectoIPSHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
