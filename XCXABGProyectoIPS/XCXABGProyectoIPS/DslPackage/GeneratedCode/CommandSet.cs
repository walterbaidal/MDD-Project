...
namespace IPS_GT16.XCXABGProyectoIPS
{
	...
	/// </summary>
	internal partial class XCXABGProyectoIPSCommandSet : XCXABGProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSCommandSet.
		/// </summary>
		public XCXABGProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class XCXABGProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSCommandSetBase.
		/// </summary>
		protected XCXABGProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewXCXABGProyectoIPSExplorerCommand,
				typeof(XCXABGProyectoIPSEditorFactory).GUID);
		...
		{
			XCXABGProyectoIPSExplorerToolWindow explorer = this.XCXABGProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected XCXABGProyectoIPSDocData CurrentXCXABGProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as XCXABGProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected XCXABGProyectoIPSDocView CurrentXCXABGProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as XCXABGProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected XCXABGProyectoIPSExplorerToolWindow XCXABGProyectoIPSExplorerToolWindow
		{
			get
			{
				XCXABGProyectoIPSExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(XCXABGProyectoIPSExplorerToolWindow), true) as XCXABGProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				XCXABGProyectoIPSExplorerToolWindow explorerWindow = this.XCXABGProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class XCXABGProyectoIPSClipboardCommandSet : XCXABGProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSClipboardCommandSet.
		/// </summary>
		public XCXABGProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class XCXABGProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new XCXABGProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected XCXABGProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
